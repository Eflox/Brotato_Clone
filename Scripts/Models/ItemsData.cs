            ...
            {
                {
                    "WellRounded", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Well_Rounded"),
                ...
                },
                {
                    "Brawler", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Brawler"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                ...
                },
                {
                    "Crazy", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Crazy"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = new BrawlerAttributeData()
                    }
                },
                {
                    "Ranger", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Ranger"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Mage", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Mage"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Chunky", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Chunky"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Old", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Old"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Lucky", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Lucky"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Mutant", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Mutant"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Generalist", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Generalist"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Loud", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Loud"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Multitasker", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Multitasker"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Wildling", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Wildling"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Pacifist", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Pacifist"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Gladiator", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Gladiator"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Saver", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Saver"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Sick", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Sick"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Farmer", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Farmer"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Ghost", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Ghost"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Speedy", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Speedy"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Entrepreneur", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Entrepreneur"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Engineer", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Engineer"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Explorer", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Explorer"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Doctor", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Doctor"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Hunter", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Hunter"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Artificer", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Artificer"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "ArmsDealer", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Arms_Dealer"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Streamer", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Streamer"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Cyborg", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Cyborg"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Glutton", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Glutton"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Jack", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Jack"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Lich", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Lich"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Apprentice", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Apprentice"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Cryptid", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Cryptid"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Fisherman", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Fisherman"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Golem", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Golem"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "King", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/King"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Renegade", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Renegade"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "OneArmed", new NItem
                    {
                        Name = "OneArmed",
                        Description = "[g]+2[c] projectiles [nl]Projectiles pierce through [g]1[c] additional target [nl][g]+10% Damage[c] for every different Tier I item you have [nl]You can't equip melee weapons [nl][r]-400%[c] Damage [nl][r]-50%[c] accuracy [nl][r]% Damage[c] modifications are reduced by [r]80%[c]",
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/One_Armed"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Bull", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Bull"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Soldier", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Soldier"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Masochist", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Masochist"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Knight", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Knight"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
                },
                {
                    "Demon", new NItem
                    {
                        ...
                        Icon = Resources.Load<Sprite>($"{_assetSource}/Sprites/Characters/Demon"),
                        Rarity = Rarity.Common,
                        Classes = new Class[] { Class.Character },
                        Attribute = null
                    }
